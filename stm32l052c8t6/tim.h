...
#ifndef _STM32L052C8T6_TIM_H
#define _STM32L052C8T6_TIM_H
...
/* Capture/compare 4 output polarity */
#define TIM_CCER_CC4NP_LSB      15
#define TIM_CCER_CC4NP_MASK     (1 << TIM_CCER_CC4NP_LSB)
